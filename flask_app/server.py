...
from flask_app.api import DummyEndpoint
from flask_app.api import HelloEndpoint
from flask_app.api import SentimentEndpoint
from flask_app.api import TrendsEndpoint
...
class CustomFlaskApp(object):
    ...
    def __init__(self):
        ...
        self.api.add_resource(SentimentEndpoint, '/sentiment', endpoint='sentiment')
        self.api.add_resource(TrendsEndpoint, '/trends', endpoint='trends')
